              ...
              >
                ...
                <div className="id-card-face id-card-back">
                  ...
                  <div className="social-links-container">
                    {/* INSTAGRAM */}
                    <a href="https://instagram.com/tu_usuario" target="_blank" rel="noreferrer" className="social-btn" onClick={(e) => e.stopPropagation()}>
                    ...
                    {/* YOUTUBE */}
                    <a href="https://youtube.com/c/tu_canal" target="_blank" rel="noreferrer" className="social-btn" onClick={(e) => e.stopPropagation()}>
